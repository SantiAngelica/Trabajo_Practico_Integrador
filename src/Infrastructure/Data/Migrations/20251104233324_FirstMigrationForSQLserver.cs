...
{
    /// <inheritdoc />
    public partial class FirstMigrationForSQLserver : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyAdress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PropertyZone = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserComents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserComents_Users_CommenterId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Age", "Email", "Name", "Password", "Role", "Zone" },
                values: new object[,]
                {
                    { 1, 30, "admin@example.com", "Admin", "1234", 2, "Centro" },
                    { 2, 25, "juan@example.com", "Juan Pérez", "1234", 0, "Norte" },
                    { 3, 28, "maria@example.com", "María López", "1234", 1, "Sur" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserComents_CommenterId",
                table: "UserComents",
                column: "CommenterId");
